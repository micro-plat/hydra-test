...
func TestDelay(t *testing.T) {
	...
	tests := []*testCase{
		...
		{name: "2. delay-配置错误的头名称", isSet: true, header: map[string]interface{}{"errorname": "111"}, delayTime: "0", wantStatus: 200, wantSpecial: ""},
		{name: "3. delay-配置错误的数据", isSet: true, header: map[string]interface{}{"X-Add-Delay": "errdata"}, delayTime: "0", wantStatus: 200, wantSpecial: "delay"},
		{name: "4. delay-配置延迟0s", isSet: true, header: map[string]interface{}{"X-Add-Delay": "0"}, delayTime: "0", wantStatus: 200, wantSpecial: "delay"},
		{name: "5. delay-配置延迟1s", isSet: true, header: map[string]interface{}{"X-Add-Delay": "1s"}, delayTime: "1s", wantStatus: 200, wantSpecial: "delay"},
		{name: "6. delay-配置延迟3秒", isSet: true, header: map[string]interface{}{"X-Add-Delay": "3s"}, delayTime: "3s", wantStatus: 200, wantSpecial: "delay"},
	}
