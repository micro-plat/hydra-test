...
//1.1 使用 ./headerserver02 run
//1.2 请求不设置Origin头：http://localhost:8072/hydratest/apiserver/header  返回：配置header中所有的非空header列表
//1.3 请求设置Origin头：http://localhost:8072/hydratest/apiserver/header  返回：配置header中所有的非空header列表
func main() {
	app.Start()
}
