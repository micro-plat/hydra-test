...
/*
通过postman构建如下请求：
1.1 请求路由无编码格式接口-Post-file-ut8-与头编码相同         返回正确的数据
1.2 请求路由无编码格式接口-Post-file-ut8-与头编码不同         无法获取数据
1.3 请求路由无编码格式接口-Post-file-gbk-与头编码相同         返回正确的数据
1.4 请求路由无编码格式接口-Post-file-gbk-与头编码不同         无法获取数据
1.5 请求路由无编码格式接口-Post-file-gb2312-与头编码相同       返回正确的数据
1.6 请求路由无编码格式接口-Post-file-gb2312-与头编码不同         无法获取数据

2.1 请求路由有编码格式接口-Post-file-ut8-与路由编码相同         返回正确的数据
2.2 请求路由有编码格式接口-Post-file-ut8-与路由编码不同         无法获取数据
2.3 请求路由有编码格式接口-Post-file-gbk-与路由编码相同         返回正确的数据
2.4 请求路由有编码格式接口-Post-file-gbk-与路由编码不同         无法获取数据
2.5 请求路由有编码格式接口-Post-file-gb2312-与路由编码相同       返回正确的数据
2.6 请求路由有编码格式接口-Post-file-gb2312-与路由编码不同         无法获取数据

3.1 头和路由都有编码-编码不同-Get-file-gbk-utf8-与头编码相同        无法获取数据
3.2 头和路由都有编码-编码不同-Get-file-gbk-utf8-与路由编码相同      返回正确的数据
*/
