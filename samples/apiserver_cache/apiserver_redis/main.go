...
func init() {
	...
	hydra.Conf.Vars().Cache().Redis(cacheName, "192.168.5.79:6379")
	...
	hydraApp.API("/api/redis/incrint", incrementIntHandler)
	hydraApp.API("/api/redis/decrint", decrementIntHandler)
